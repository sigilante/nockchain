...
::  (014-aletheia). Each post-activation coinbase puts +protocol-fund-address into the
...
::  3-of-4 multisig lock-root == the value pinned in +protocol-fund-address.
...
~&  protocol-fund-address+(to-b58:hash fund-addr)
