...
The exact pushed source at commit `62a309284800d4eeb30498064ba40c44b265834b` and tree `7dd9f18e04d723f52b4d1db435b089da1813791a` was rebuilt cleanly on `wx-workstation`; the release binary SHA-256 was `4734895f403db6cc4118caeb9e0a15717e8c1edce8ac0b1a7d0594f77ba34f40`. A final balanced check ran candidate/control, control/candidate, and candidate/control. The three pairs were 85.35/88.10, 85.42/87.94, and 86.44/86.66 seconds, so every pair was positive. Aggregate final means were 85.737 seconds candidate and 87.567 seconds control, a 2.134% compile-throughput gain. All six balanced artifacts had the accepted Dumbnet SHA-256.

The same exact release binary independently rebuilt all six production kernels successfully. Their SHA-256 values were Dumbnet `2b5b0f77937f5162ed0e6c8f8ebd2651761576798f79dfa95a079d490423bb01`, Wallet `7f6fc956b87f660f7371bd2caf955f4d2610103bd5a05c1c20e0fce66fbfa474`, Miner `1a7615c7af9df85066c9981a30e3bfe128dd11f7e1760df182014a7cbb3aa418`, Peek `9af1f26217fc3226f190bece929da7ac181b427fd721e42081faa731657fe094`, Bridge `6304ae91b546e0fe39d3be6e558d4710278904151c86406e37e4a903fcd8e7c3`, and Roswell `612025fc58d84dcd226c4b7c0b49602a4c86a430683d6b22b66a3e109815a842`. The local correctness matrix passed 143 Honk library tests, 70 compiler-mint integration tests, two compiler acceptance/rejection probes, 276 Hatch library tests, and 183 NockVM library tests with four pre-existing ignored NockVM tests. `cargo check -p honk --all-targets`, `cargo fmt --all -- --check`, and `git diff --check` also passed.
